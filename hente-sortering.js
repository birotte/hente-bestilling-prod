(function () {
  ...
  const GLYPHS = {
    ...
    'bad':      `<g fill="none" stroke="${w}" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M 6 16 h 20 v 2.5 a 5 5 0 0 1 -5 5 h -10 a 5 5 0 0 1 -5 -5 z"/><path d="M 8.5 16 V 9 a 2.5 2.5 0 0 1 5 0"/><line x1="11" y1="23.5" x2="10" y2="26"/><line x1="21" y1="23.5" x2="22" y2="26"/></g>`,
  };
  ...
  const FRAKSJONER = [
    { id: 'restavfall', name: 'Restavfall',         color: '#1a1a1a', icon: 'trash',
      ...
      no:  ['Svarte avfallssekker &#8211; avfallet m&#229; leveres synlig','Farlig avfall','Batterier','Elektronikk','Masser og stein','Impregnert treverk'] },
    ...
    { id: 'baderomsmiks', name: 'Baderomsmiks',     color: '#0e7490', icon: 'bad',
      desc: 'Blandet, tungt rivingsavfall fra bad &#8211; betong, fliser og gips i ett, n&#229;r materialene ikke lar seg skille.',
      yes: ['Betonggulv','Avrettingsmasse med inst&#248;pt varmekabel','Tynt armeringsjern','Fliser','Gipsrester med fastlimte fliser'],
      no:  ['Trevirke','Plast','Isolasjon','Sanit&#230;rporselen','EE-avfall','R&#248;r','Rene gipsplater','Isopor','Maling og farlig avfall','Forurensede masser'] },
